...
while t < P.end_time:
    ...
    while t < t_next_plot:
        ...
        deltaTemp ,phi_c,theta_c,chi_c,altitude_state = Autopilot.autopilot(gains, u_state) 
        ...
        Pnd = pn_2 - pn_1
        Ped = pe_1 - pe_2
        chi_c2 = np.arctan(Ped/(Pnd+0.000001))

        u_state = np.array([t,phi,theta,chi,p,q,r,Va,h,Va_c2,h_c2,chi_c2])
        deltaTemp,phi_c,theta_c,chi_c,altitude_state = Autopilot2.autopilot(gains2, u_state) 
